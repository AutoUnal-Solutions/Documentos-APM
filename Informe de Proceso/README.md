...
- Yeira
Se puede plantear una ruta diferente de trabajo que priorice el fortalecimiento de habilidades técnicas desde la primera semana, con el fin de que al final los integrantes se puedan concentrar en el desarrollo del proyecto más no en el aprendizaje del uso de las herramientas. Por parte del equipo, se valoraría una mejor una división de tareas, menos seccionada que invite a la participación conjunta con cada miembro del equipo.
